    ...
    <div class="post">
      ...
      <div class="post-content">
        <p>
          ...
          pierniczków: wałkowanie, wycinanie wybranymi świątecznymi foremkami i
      ...
      <article class="post">
        ...
        <div class="post-content">
          <p>
            Jest to ciekawa propozycja dla kreatywnego i produktywnego spędzenia
            czasu. Na zajęciach zapoznać się będzie można się z techniką
            wykonania świec, temperaturą topnienia i obróbką parafiny. Wykonane
            świece zostają zabrane do domu.
          </p>
          <div class="post-preview">
            <div class="row text-center text-lg-center">
              <div class="col-lg-12 col-md-3 col-xs-3">
      ...
      <article class="post">
        ...
        <div class="post-content">
          <p>
            ...
            nauczyć się rozpoznawać zioła, oraz ich działanie. Na warsztatach
            można zyskać podstawowe wiadomości związane z poznaniem ziół w
            terenie, ich nazewnictwem, właściwościami, zastosowaniem w
            ziołolecznictwie i kuchni. Podczas warsztatów można zdegustować
            potraw, syropów i dżemów.
          </p>
          <div class="post-preview">
            <div class="row text-center text-lg-center">
              <div class="col-lg-12 col-md-3 col-xs-3">
      ...
      <article class="post">
        ...
        <div class="post-content">
          <p>
            Idealny pomysł na spędzenie czasu w kuchni, stwarzając wyśmienite
            dania, których skład oraz smak zadziwi wszystkich domowników. Zupa z
            pokrzyw, konfitura z dzikiej róży, ciastka z lawendą, to tylko
            niektóre propozycje. Zapraszamy do samodzielnego zapoznania się i
            spróbowania innych dań z ziołami.{" "}
          </p>
        </div>
      </article>
    </div>
