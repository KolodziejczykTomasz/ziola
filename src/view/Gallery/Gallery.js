  ...
  <>
    ...
    <Grid>
      <Grid.Column mobile={16} tablet={16} computer={12}>
        <Grid.Row style={{ padding: "0 30px", justifyContent: "center" }}>
          ...
          <Grid.Column className={styles.cardItem}>
            <Link as={Link} to="/galleryProduct">
              <Card>
                ...
                <Card.Content>
                  <Card.Header>
                    <span className={styles.cardHeader}>Produkty</span>
                  </Card.Header>
                </Card.Content>
              </Card>
            </Link>
          ...
          <Grid.Column className={styles.cardItem}>
            <Link as={Link} to="/galleryGarden">
              <Card>
                ...
                <Card.Content>
                  <Card.Header>
                    <span className={styles.cardHeader}>Ogródek ziołowy</span>
                  </Card.Header>
                </Card.Content>
              </Card>
            </Link>
          ...
          <Grid.Column className={styles.cardItem}>
            <Link as={Link} to="/galleryHerbs">
              <Card>
                ...
                <Card.Content>
                  <Card.Header>
                    <span className={styles.cardHeader}>Zioła </span>
                  </Card.Header>
                </Card.Content>
              </Card>
            </Link>
          ...
          <Grid.Column className={styles.cardItem}>
            <Link as={Link} to="/galleryAcitivity">
              <Card>
                ...
                <Card.Content>
                  <Card.Header>                 
                    <span className={styles.cardHeader}>Działalność</span>
                  </Card.Header>
                </Card.Content>
              </Card>
            </Link>
