          ...
          <Segment>
            ...
            <div className={styles.post}>
              <p className={styles.postDescription}>
                ...
                którego powstaną słodkie pierniczki. Do przygotowania
                wspaniałego ciasta potrzebne są wszystkie zmysły. Idealne ciasto
                otrzymujemy poprzez wąchanie, smakowanie i ugniatania ciasta,
                które staje się plastyczne pod wpływem ciepła rąk. Oferta
                obejmuje robienie własnych pierniczków: wałkowanie, wycinanie
                wybranymi świątecznymi foremkami i ozdabianie wg. własnego
                pomysłu
              </p>
            </div>
          </Segment>
          ...
          <Segment>
            ...
            <div className={styles.post}>
              <p className={styles.postDescription}>
                ...
                domowników. Zupa z pokrzyw, konfitura z dzikiej róży, ciastka z
                lawendą, to tylko niektóre propozycje. Zapraszamy do
                samodzielnego zapoznania się i spróbowania innych dań z ziołami.
              </p>
            </div>
          </Segment>
        </Grid.Row>
