    ...
    <Grid>
      <Grid.Column mobile={16} tablet={16} computer={12}>
        <Grid.Row style={{ padding: "0 30px", justifyContent: "center" }}>
          ...
          <Grid.Column className={styles.cardItem} mobile={16}>
          ...
          <Grid.Column className={styles.cardItem}>
            <Link as={Link} to="/flatGabrys">
              <Card>
                <img alt="Noclegi" className={styles.cardImage} src={Gabrys} />
                <Card.Content>
                  <Card.Header>
                    <p className={styles.Header}>
          ...
          <Grid.Column className={styles.cardItem}>
            <Link as={Link} to="/flatKolecka">
              <Card>
                <img alt="Noclegi" className={styles.cardImage} src={Kolecka} />
                <Card.Content>
                  <Card.Header>
                    <p className={styles.Header}>
