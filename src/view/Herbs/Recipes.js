          ...
          <Segment style={{ width: "100%" }}>
            ...
            <div>
              <div>
                ...
                <p className={styles.DescritpionText}>
                  Zrywamy świeże młode liście pokrzywy, należy je opłukać zimną
                  wodą, zaparzyć wrzątkiem. Kroimy drobno, przekładamy na
                  patelnię, podsmażamy na maśle, dodajemy cebulę i czosnek, sól,
                  pieprz, łączymy z serem. Uformowane naleśniki obsmażamy z obu
                  stron. Wspaniałe!
                </p>
              </div>
            </div>
