...
const newsHomepage = [
  ...
  {
    src: Dożynki,
    title: "Dożynki Prezydenckie 2019",
    text1:
      "Jak co roku, 15 września w Spale koło Łodzi odbywały się Dożynki Prezydenckie.",
    text2:
      "Województwo warmińsko – mazurskie reprezentowały m.in. Babki Zielarki z Blanek, jako wieś tematyczna „Zielarska Wieś Blanki”, które wprowadzały wszystkich w świat ziół. ",
    text3:
  ...
  {
    src: Zioła2019,
    title: "Festiwal Ziół 2019",
    text1:
      "Blanki znów pachniały ziołami i rozbrzmiewały muzyką. A to wszystko za sprawą kolejnego Festiwalu Ziół, który 13 lipca odbył się w tej wsi. Świętowanie rozpoczęto, jak co roku Mszą Święta celebrowaną przez księdza Adama Narbuta w kościele parafialnym w Blankach.",
    text2:
      "Po mszy rozpoczęto oficjalnie IV Festiwal Ziół. Gości przywitała Babka Zielarka Lucja Kuczyńska wraz z Zastępcą Wójta Tomaszem Kołodziejczykiem i Przewodniczącym Rady Gminy Markiem Werbickim. Na scenie zaprezentowali się: Zespół Tańca Ludowego Perła Warmii, grupa taneczna Chorsina, Kapele Ludowe Furman i Rogóżanie, zespół instrumentalno – wokalny Contra Band’a oraz solistki z Gminnego Ośrodka Kultury i Sportu w Pilniku.",
    text3:
      "Gwiazdą festiwalu był Czerwony Tulipan, który zgromadził wielu swoich fanów. Nie zabrakło oczywiście stoisk degustacyjnych, gdzie skosztować można było nalewek i syropów z miejscowych ziół i owoców, oraz zupy z pokrzyw. ",
    text4:
